...
def advancedresults(request):
	...
	return render(request, 'results.html', {'redditReturn': redditReturn, 'twitterReturn': twitterReturn, 'searchQuery': searchQuery, 'data': data, 'data1' : data1,'twitterString':twitterString})
